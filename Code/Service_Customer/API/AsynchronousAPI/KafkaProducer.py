...
class ProduceToBroker(object):
    ...
    def delivery_report(self, err, msg, Details):
        msg = json.loads(msg)
        print(f'Message:Send, Service: Πελάτες, EventType:{msg["Message"]["Head"]["EventType"]}')
        CustomerRepository().UpdateEventThatItHasBeenPublished(Details[0],Details[1],Details[2]) #Update the event that was published successfully
