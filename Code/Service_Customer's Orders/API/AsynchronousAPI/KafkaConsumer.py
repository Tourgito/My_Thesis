...
def Consumes(c):
    ...
    while True:
        ...
        if ServiceRepository().CheckDuplicatedMessages(Msg['Message']['Head']['MessageId']): #If Message is not duplicated
            print(f'Message:Received, Service:Παραγγελίες πελατών, EventType:{Msg["Message"]["Head"]["EventType"]}')
...
if __name__ == '__main__':
    CostumerServiceMessagesConsumer = CreateConsumer('CustomerOrdersGroup',['OrderServiceEventChannel', 'CustomerServiceEventChannel']) #Creates the Kafka consumer
